<div class="grid grid-rows-1 p-6 text-white">
    <div class="flex justify-between mb-5">
        <h2 class="card-title text-white">SKPTS!</h2>
        <a href="{{ route('skpts.create') }}" wire:navigate
            class="btn btn-load btn-sm bg-amber-500 hover:bg-amber-600 text-white">Add
            New</a>
    </div>
    <div>
        <livewire:skpts.table :lazy="true" />
    </div>

    {{-- <x-filament::modal :close-button="true" id="view-kutipan" width="6xl">
        @if ($modalData)
