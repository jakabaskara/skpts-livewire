<div class="min-w-fit">
    ...
    <!-- Sidebar -->
    <div id="sidebar"
        class="flex lg:!flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-gray-800 p-4 transition-all duration-200 ease-in-out {{ $variant === 'v2' ? 'border-r border-gray-700/60' : ' shadow-sm' }}"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard.index') }}">
                <svg class="fill-yellow-300" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
                    <path
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <x-nav-link :active="Request::segment(1) === 'home'" href="{{ route('dashboard.index') }}">
                        Home
                    </x-nav-link>
                    <x-nav-link :active="Request::segment(1) === 'skpts'" href="{{ route('skpts.index') }}">
                        SKPTS
                    </x-nav-link>
                    <x-nav-link :active="Request::segment(1) === 'karyawan'" href="{{ route('karyawan.index') }}">
                        Karyawan
                    </x-nav-link>
                </ul>
            </div>
